...
load_kg_day <- stream$DISCHARGE*stream$DIC*ConvertLoadToKgDay
...
library(xlsx)
write.csv(df,file='pheasant_dic.csv',row.names=FALSE)
write.csv(df,file='yahara_dic.csv',row.names=FALSE)
write.csv(df,file='sixmile_dic.csv',row.names=FALSE)
write.csv(df,file='dorn_dic.csv',row.names=FALSE)
