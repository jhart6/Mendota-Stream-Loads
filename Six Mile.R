#Script to develop C load estimates to Lake Mendota from Six Mile
#12/12/16
...
stream<-read.csv("Six Mile.csv") #JAH
...
#sixmile[poc] = linear model
#sixmile[doc] = linear model
...
poc_load_over_Q<-(sixmile_poc_kg_day/Q_m3_day)
sixmile_poc_mmol<-(poc_load_over_Q*carbon_kg_to_mmol)
